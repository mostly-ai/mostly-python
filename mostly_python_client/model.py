...
#   filename:  https://raw.githubusercontent.com/mostly-ai/mostly-app-v2/llb2/mstar/public-api/public-api.yaml?token=GHSAT0AAAAAABI33CIILZYAGAGH75EVRISYZMANGJA
#   timestamp: 2023-12-18T14:59:18+00:00
...
class SyntheticTableConfiguration(CustomBaseModel):
    ...
    imputation: Annotated[
        Optional[List[str]],
        Field(
            description="Specify a list of column IDs that are to be imputed.\nImputed columns will suppress the sampling of NULL values.\n"
        ),
    ] = None
