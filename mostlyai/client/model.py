...
#   timestamp: 2024-12-10T16:40:49+00:00
...
class Credits(CustomBaseModel):
    ...
    period_start: Optional[AwareDatetime] = Field(
        None,
        alias="periodStart",
        description="The UTC date and time when the current time period started",
    )
    period_end: Optional[AwareDatetime] = Field(
        None,
        alias="periodEnd",
...
class SyntheticDatasetListItem(CustomBaseModel):
    ...
    generation_time: Optional[AwareDatetime] = Field(
        None,
...
class GeneratorListItem(CustomBaseModel):
    ...
    training_time: Optional[AwareDatetime] = Field(
        None,
        alias="trainingTime",
