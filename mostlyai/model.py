...
#   timestamp: 2024-08-26T12:21:54+00:00
...
import pandas as pd
from pydantic import AwareDatetime, Field, RootModel, field_validator, validator
...
class ModelConfiguration(CustomBaseModel):
    ...
    model: Annotated[
        ...
        Field(
            ...
            examples=[
                [
                    "TABULAR/MOSTLY_AI/Small",
                    "TABULAR/MOSTLY_AI/Medium",
                    "TABULAR/MOSTLY_AI/Large",
                    "LANGUAGE/MOSTLY_AI/LSTM",
                    "LANGUAGE/HuggingFaceTB/SmolLM-360M",
                ]
            ],
        ),
    ] = None
