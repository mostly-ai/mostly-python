...
#   timestamp: 2024-05-28T12:47:31+00:00
...
class Metadata(CustomBaseModel):
    ...
    short_lived_file_token: Annotated[
        ...
        Field(
            ...
            description="An auto-generated short-lived file token (`slft`) for accessing resource artefacts.\nThis token can be used as an alternative to a session token or an API key, \nbut is restricted to a single resource, is only valid for 10 minutes, \nand is only accepted by file-specific API endpoints.\n",
        ),
    ] = None
