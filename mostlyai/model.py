...
#   timestamp: 2024-12-05T06:28:42+00:00
...
class UserSettingsProfileUpdateConfig(CustomBaseModel):
    ...
    last_name: Annotated[
        Optional[str],
        Field(None, alias="lastName", description="Last name of a user", max_length=30),
    ] = None
...
class ConnectorCreateConfig(CustomBaseModel):
    name: Annotated[
        Optional[str], Field(None, description="The name of a connector")
    ] = None
    type: ConnectorType
    access_type: Annotated[
        Optional[ConnectorAccessType], Field("SOURCE", alias="accessType")
    ] = "SOURCE"
    config: Optional[Dict[str, Any]] = None
    secrets: Optional[Dict[str, str]] = None
    ssl: Optional[Dict[str, str]] = None
...
class GeneratorCloneTrainingStatus(Enum):
    """
    The training status of the new generator.
    """
...
class SourceForeignKeyCreateConfig(CustomBaseModel):
...
class SourceColumnCreateConfig(CustomBaseModel):
    name: Annotated[str, Field(description="The name of a source column")]
    included: Annotated[
        Optional[bool],
        Field(
    ...
    model_encoding_type: Annotated[
        Optional[ModelEncodingType], Field("AUTO", alias="modelEncodingType")
    ] = "AUTO"
...
class SyntheticDatasetPatchConfig(CustomBaseModel):
    name: Annotated[
        Optional[str], Field(None, description="The name of a synthetic dataset")
    ] = None
    description: Annotated[
        Optional[str], Field(None, description="The description of a synthetic dataset")
    ] = None
...
class AssistantThreadCreateConfig(CustomBaseModel):
    name: Annotated[
...
class AssistantMessageCreateConfig(CustomBaseModel):
    """
...
class ComputeCreateConfig(CustomBaseModel):
    name: Optional[str] = None
    type: Optional[Literal["KUBERNETES"]] = None
    resources: Optional[ComputeResources] = None
    config: Optional[Dict[str, Any]] = None
...
class ShareCreateConfig(CustomBaseModel):
...
class GeneratorCloneConfig(CustomBaseModel):
    training_status: Annotated[
        Optional[GeneratorCloneTrainingStatus], Field("NEW", alias="trainingStatus")
    ] = "NEW"
...
class ModelConfiguration(CustomBaseModel):
    ...
    differential_privacy: Annotated[
        Optional[ModelConfigurationDifferentialPrivacy],
        Field(None, alias="differentialPrivacy"),
    ] = None
...
class ProgressStep(CustomBaseModel):
    ...
    compute_name: Annotated[Optional[str], Field(None, alias="computeName")] = None
    restarts: Annotated[
        Optional[int],
        Field(
...
class SyntheticTableCreateConfig(CustomBaseModel):
    name: Annotated[
        Optional[str],
        Field(
            None,
...
class ResourceShares(CustomBaseModel):
    is_public: Annotated[Optional[bool], Field(None, alias="isPublic")] = None
...
class SourceTableCreateConfig(CustomBaseModel):
    name: Annotated[
        Optional[str],
        Field(
            None,
    ...
    foreign_keys: Annotated[
        Optional[List[SourceForeignKeyCreateConfig]],
        Field(
            None,
            alias="foreignKeys",
    ...
    columns: Annotated[
        Optional[List[SourceColumnCreateConfig]],
        Field(None, description="The column configurations of this table."),
    ] = None
...
class SyntheticDatasetCreateConfig(CustomBaseModel):
    ...
    tables: Optional[List[SyntheticTableCreateConfig]] = None
    delivery: Optional[SyntheticDatasetDelivery] = None


class SyntheticProbeCreateConfig(CustomBaseModel):
    generator_id: Annotated[
        Optional[str],
        Field(
            None,
...
class GeneratorCreateConfig(CustomBaseModel):
    name: Annotated[
        Optional[str], Field(None, description="The name of a generator")
    ] = None
    description: Annotated[
    ...
    tables: Optional[List[SourceTableCreateConfig]] = None
