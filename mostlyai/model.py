...
#   timestamp: 2024-09-18T15:56:08+00:00
...
class Distances(CustomBaseModel):
    dcr_training: Annotated[
        ...
        Field(
            None,
            alias="dcrTraining",
            description="The average DCR between the synthetic and the training records.",
        ),
    ] = None
    dcr_holdout: Annotated[
        ...
        Field(
            None,
            alias="dcrHoldout",
            description="The average DCR between the synthetic and the holdout records.",
        ),
    ] = None
