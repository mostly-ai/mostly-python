...
#   filename:  https://raw.githubusercontent.com/mostly-ai/mostly-app-v2/llb2/mstar/public-api/public-api.yaml?token=GHSAT0AAAAAABI33CIJWX5PBQAPRAFTDAG4ZMYC7FA
#   timestamp: 2024-01-05T13:56:33+00:00
...
class Generator(CustomBaseModel):
    ...
    def add_table_by_upload(self, **kwargs):
        if self.client and hasattr(self.client, "add_table_by_upload"):
            return self.client.add_table_by_upload(gnerator_id=self.id, **kwargs)
