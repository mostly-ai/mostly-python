...
#   timestamp: 2024-06-21T12:02:58+00:00
...
class SyntheticTableFairness(CustomBaseModel):
    ...
    target_column: Annotated[Optional[str], Field(None, alias="targetColumn")] = None
    sensitive_columns: Annotated[
        Optional[List[str]], Field(None, alias="sensitiveColumns")
    ] = None
