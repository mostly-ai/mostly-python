...
#   timestamp: 2024-11-20T23:05:18+00:00
...
class User(CustomBaseModel):
    ...
    first_name: Annotated[
        Optional[str],
        Field(None, alias="firstName", description="First name of a user"),
    ] = None
    last_name: Annotated[
        Optional[str], Field(None, alias="lastName", description="Last name of a user")
    ] = None
